...
export const shrinkingWeekArticle: LearnArticle = {
  ...
  body: [
    ...
    {
      type: "p",
      text: "IOFitness is being designed around that kind of decision. The intended model is duration-aware and priority-aware: when time or days shrink, the system should cut from the bottom of the priority list, not hand you an unrelated starter template and call it adaptation.",
    },
